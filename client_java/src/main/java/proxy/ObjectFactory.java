...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://ws.iga.ma/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://ws.iga.ma/", "ConvertResponse");
    private static final QName _Compte_QNAME = new QName("http://ws.iga.ma/", "compte");
    private static final QName _CompteList_QNAME = new QName("http://ws.iga.ma/", "compteList");
    private static final QName _CompteListResponse_QNAME = new QName("http://ws.iga.ma/", "compteListResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.iga.ma/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.iga.ma/", "getCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.iga.ma/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.iga.ma/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.iga.ma/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.iga.ma/", name = "compteList")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.iga.ma/", name = "compteListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.iga.ma/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.iga.ma/", name = "getCompteResponse")
