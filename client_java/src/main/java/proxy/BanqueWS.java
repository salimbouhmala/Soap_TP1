 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.iga.ma/", wsdlLocation = "http://localhost:9191/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.iga.ma/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.iga.ma/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.iga.ma/", "BanqueServicePort"), BanqueService.class, features);
    }
